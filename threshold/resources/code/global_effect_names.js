...
return {
    ...
    MOVED_SHORT_OUT_OF_COVER: "moved 1m out of cover",
    ...
    NU: "new", // not used directly: a convenience to match any other NU effect
    NU_ARM: "new arm",
    NU_EAR: "new ear",
    NU_EYE: "new eye",
    NU_FACE: "new face",
    NU_FINGER: "new finger",
    NU_FOOT: "new foot",
    NU_HAND: "new hand",
    NU_JAW: "new jaw",
    NU_LEG: "new leg",
    NU_NOSE: "new nose",
    NU_ORGANS: "new organs",
    NU_TOE: "new toe",
    PRONE: "prone",
    STUNNED: "stunned",
